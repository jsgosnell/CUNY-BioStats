...
mtext("Distribution of 9000 means of n draws from a standard normal (Z) distribution", outer = T, side = 1, 
      cex = 2, line = 1)
...
mtext("Distribution of 9000 means of n draws from a double exponential distribution", outer = T, side = 1, 
      cex = 2, line = 1)
...
mtext("Distribution of 9000 means of n draws from a uniform distribution", outer = T, side = 1, 
      cex = 2, line = 1)
...
mtext("Distribution of 9000 means of n draws from an exponential distribution", outer = T, side = 1, 
      cex = 2, line = 1)
...
mtext("Distribution of 9000 means of n draws from a chi square (df = 4) distribution", outer = T, side = 1, 
      cex = 2, line = 1)
...
mtext("Distribution of 9000 means of n draws from a binomial distribution, p = .7", outer = T, side = 1, cex = 2, line = 1)
