...
```{r}
# ghosts <- data.frame (Present = c(rep("Present", 30), rep("Absent", 30)), 
#                       Temperature = c(rnorm(30, 55, 5), rnorm(30, 58, 4)))
# write.csv(ghosts, "ghosts.csv", row.names = F)
```
...
bootstrapjsg(ghosts[ghosts$Present == "Present", "Temperature"], null=53)
```
