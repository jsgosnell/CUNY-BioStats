...
```
    ...
    ## S vs. N -56.10126 -93.57066  -7.78093 0.00000
    ## S vs. E -12.51609 -50.29555  24.99780 0.43072
    ## S vs. W  39.25821   9.51393  76.29480 0.00334
    ## S vs. C  -0.97532 -32.56963  33.66839 0.96494
    ## N vs. E  43.58517  -2.02211  80.73947 0.00668
    ## N vs. W  95.35948  61.78380 139.63498 0.00000
    ## N vs. C  55.12595  19.40071  88.51440 0.00000
    ## E vs. W  51.77430  20.93611  80.22641 0.00000
    ## E vs. C  11.54077 -19.00021  37.77503 0.28715
    ## W vs. C -40.23353 -63.04915 -17.74099 0.00000
...
```
    ...
    ##  [1] 0.00000000 0.81135225 0.00000000 0.99165275 0.01335559 0.00000000
    ##  [7] 0.00000000 0.00000000 0.81135225 0.00000000
...
```
    ...
    ## Linear Hypotheses:
    ##            Estimate Std. Error t value Pr(>|t|)    
    ## E - C == 0   39.360     14.249   2.762  0.04399 *  
    ...
    ## W - N == 0  -27.569     11.739  -2.348  0.12597    
    ## W - S == 0   35.638     10.850   3.285  0.00882 ** 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## (Adjusted p values reported -- single-step method)
