...
methods are demonstrated as well. Using an ANOVA, we found
F<sub>2,147</sub>= 1180.2, which led to a p-value of \<.001. Given this,
I reject the null hypothesis there is no difference among mean
...
```
    ...
    ## S vs. N -56.10126 -91.95174 -13.21830 0.00000
    ## S vs. E -12.51609 -51.00457  24.91617 0.34725
    ## S vs. W  39.25821   8.81848  70.85849 0.00000
    ## S vs. C  -0.97532 -28.72174  30.59070 0.85142
    ## N vs. E  43.58517   6.47065  84.40338 0.00334
    ## N vs. W  95.35948  62.12632 127.46464 0.00000
    ## N vs. C  55.12595  23.24531  88.72007 0.00000
    ## E vs. W  51.77430  22.87680  94.87001 0.00000
    ## E vs. C  11.54077 -18.76037  43.06361 0.22705
    ## W vs. C -40.23353 -64.43645 -15.61953 0.00000
...
```
    ...
    ##  [1] 0.00000000 0.85141903 0.00000000 0.92153589 0.02671119 0.00000000
    ##  [7] 0.00000000 0.00000000 0.85141903 0.00000000
...
```
    ...
    ## Linear Hypotheses:
    ##            Estimate Std. Error t value Pr(>|t|)    
    ## E - C == 0   39.360     14.249   2.762  0.04408 *  
    ...
    ## W - N == 0  -27.569     11.739  -2.348  0.12596    
...
*I used a linear model to test if exercise level impacted resting pulse
rate.*
