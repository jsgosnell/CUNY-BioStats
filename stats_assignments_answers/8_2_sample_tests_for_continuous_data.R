...
#2
fertilizer <- read.csv("https://sites.google.com/site/stephengosnell/teaching-resources/datasets/fertilizer.csv?attredirects=0&d=1")
...
#3
metabolic <- read.csv("https://sites.google.com/site/stephengosnell/teaching-resources/datasets/metabolic_rates.csv?attredirects=0&d=1")
...
#4
endurance <- read.csv("https://sites.google.com/site/stephengosnell/teaching-resources/datasets/endurance.csv?attredirects=0&d=1")
head(endurance)
