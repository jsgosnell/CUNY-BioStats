...
Results indicate that or rural parks, high drone activity areas differ from low 
and none.

- clear explanation of how results relate to your stated hypotheses (1.5 pt) 

    * I reject the null hypothesis of no interaction. Further investigation
    suggests the difference is based on rural, and not urban, parks.In rural parks,
    only high drone activity areas differ from others.
...
ggplot(decibel_summary, aes(x=drone_activity, color=park_type, y=db))+
  ...
  labs(title="Drone activity level impacts birds at rural but not urban parks",
       y= "Bird noise (db)",
       x= "Drone activity level",
       color= "Park setting",
       fill=  "Park setting")
