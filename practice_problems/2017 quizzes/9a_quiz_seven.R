...
summarySE(iris, measurevar = "Sepal.Width", groupvars = c("Species")) #close enough

#fit model
width_lm <- lm(Sepal.Width ~ Species, iris) 
...
#plot
function_output <- summarySE(iris, measurevar = "Sepal.Width", 
