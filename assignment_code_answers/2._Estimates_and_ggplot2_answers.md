...
and the **2_estimation_lecture.R** script in the lecture_files folder of
...
the beginning of lab using the central_limit_theorem.R script from the
...
![](2._Estimates_and_ggplot2_answers_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->

    ## Press [enter] to continue

![](2._Estimates_and_ggplot2_answers_files/figure-gfm/unnamed-chunk-9-2.png)<!-- -->
